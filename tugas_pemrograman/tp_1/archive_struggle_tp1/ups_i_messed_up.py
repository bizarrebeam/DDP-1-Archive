#Collab with Adelya Amanda and Ananda Dwi Hanifa

# Mohon untuk maximize layar grafik saat tower mulai digambar agar terlihat teks penjelasan dibawahnya
...
batu_bata = 0 # Deklarasi batu bata
...
# Buat objek turtle baru untuk teks
...
# Sembunyikan cursor sebelum menulis teks
t_text.hideturtle()

# Pesan yang akan tertulis sebagai penjelasan
t_text.write(pesan_mario, align="center", font=("Times New Roman", 12, "bold"))

t.hideturtle()  # Sembunyikan kursor turtle
turtle.exitonclick() # Jendela/grafik turtle agar tidak langsung menutup

# Jendela turtle tidak akan menutup sampai mengklik mouse
turtle.done()
