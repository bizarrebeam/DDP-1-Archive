...
valid = False
while not valid:
    brick_length = turtle.textinput("Enter the length of the brick (integer)")
...
valid = False
while not valid:
    brick_width = turtle.textinput("Enter the width of the brick (integer)")
...
valid = False
while not valid:
    first_tower_layer = turtle.textinput("Enter the amount of layer for the first tower (integer)")
...
valid = False
while not valid:
    layer_length = turtle.textinput("Enter the length of the layer (integer)")
