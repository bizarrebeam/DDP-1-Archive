...
begin_x = - (tower_amount * (layer_width * one_brick_width + tower_distance * one_brick_width) / 2)  # Center all towers horizontally
begin_y = - (first_tower_layer * one_brick_height / 2)  # Center all towers vertically
...
for tower in range(tower_amount):
    ...
    begin_y =  - (first_tower_layer * one_brick_height / 2)
