...
def extract_attributes_content(lines):
    try:                                                        # Attempt to parse the attributes
        ...
        for word in words:
            ...
            elif word.startswith("provinsi="):                      # and get the latter strings as info
                provinsi = word.split('"')[1].rjust(15)             # that will be displayed
    ...
    for xml_dataset in os.listdir("dataset"):
        if xml_dataset.endswith(".xml"):
            ...
            with open(xml_path, "r") as xml:
                ...
                xml_filename, provinsi, klasifikasi, sub_klasifikasi, lembaga_peradilan = extract_attributes_content(xml_file)
                ...
                if start_line != -1 and end_line != -1:    
                    ...
                    if operator is None:                                   
                        if keyword_1.lower() in xml_content:
                            total_match += 1
                            print("{} {} {} {} {}".format(xml_filename, provinsi, klasifikasi, sub_klasifikasi, lembaga_peradilan))
