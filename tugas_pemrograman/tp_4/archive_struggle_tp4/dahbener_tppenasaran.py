    ...
    def draw_barcode(self, barcode_patterns):
        ...
        for starting_line in range(2):
            ...
            self.canvas.create_line(
               30 + offset_starting_line, 30, 30 + offset_starting_line, 230, width=3, fill='blue'
            )
        ...
        for middle_line in range(2):
            self.canvas.create_line(
                barcode_position, 30, barcode_position, 230, width=3, fill='blue'
            )
            barcode_position += 6
        ...
        self.canvas.create_text(
            145, 235, fill='black', font='Courier 12 bold', text=f'{first_digit}\t{second_group}\t{third_group}'.expandtabs(2)
        )
