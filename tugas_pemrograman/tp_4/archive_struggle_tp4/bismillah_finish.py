...
class MyBarcode(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.generate_another_button = tk.Button(self, text="Generate me another barcode!", font='Consolas 10 bold', command=self.generate_another_barcode, bg='#eacdc2')
        self.exit_button = tk.Button(self, text="I'm done!", font='Consolas 10 bold', command=self.exit_application, bg='#eacdc2')
        ...
        self.label_save_barcode.grid(row=0, column=0, columnspan=2)
        self.entry_save_barcode.grid(row=1, column=0, columnspan=2)
        self.label_input_code.grid(row=2, column=0, columnspan=2)
        self.entry_input_code.grid(row=3, column=0, columnspan=2)
        self.generate_button.grid(row=4, column=0, pady=10, columnspan=2)  
        self.canvas.grid(row=5, column=0, columnspan=2)
        self.generate_another_button.grid(row=6, column=0, pady=10)
    ...
    def generate_another_barcode(self):
    # Clear the canvas and entry for generating another barcode
        self.canvas.delete('all')
        self.entry_input_code.delete(0, tk.END)
        self.entry_save_barcode.delete(0, tk.END)
